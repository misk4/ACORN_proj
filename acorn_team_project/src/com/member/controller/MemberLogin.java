...
public class MemberLogin extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
          courselist = couservice.myCourseList(userid);
      ...
      if(courselist.size()==0 && dto instanceof StudentDTO){
         request.setAttribute("iscourselist", 1);
         RequestDispatcher dis = request.getRequestDispatcher("CourseList");
