...
<body>
   ...
   <table width="700" border="3" bordercolor="lightgray" align="center">
      ...
      %>
        ...
        <tr align="center" valign="middle">
            <td colspan="6">
                ...
                <input type="button" value="삭제" onclick="location.href='BoardDelete?id=<%=id%>'">
    ...
    <div class="well" align="center">
            <h4>Leave a Comment:</h4>
               <form action="CommentWrite" role="form" method="post" >
               <div class="form-group" >
                  <textarea name="content"class="form-control" cols="50" rows="10" align="center"> </textarea>
               </div>
   ...
   <jsp:include page="reviewReplyUI.jsp" flush="true"/>
